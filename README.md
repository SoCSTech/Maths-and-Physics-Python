# Maths and Physics Python Container
This repository houses the devcontainer and docker image for Maths & Physics modules at the University of Lincoln.
## What is Docker?
...
3. Inside the extracted folder is a folder entitled 'Maths and Physics Python' which contains the .devcontainer folder. Move 'Maths and Physics Python' to wherever you like, this will be your working directory for this module.
4. Make sure Docker Desktop is running. You can minimise the window.
5. Open VS Code, go to File -> Open Folder, and select your 'Maths and Physics Python' folder.
